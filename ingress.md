...
ssl.truststore.location=/root/huzhi/kafka2.2.1_and_zookeeper3.5.9/truststore.jks
ssl.truststore.password=jY3jWEG9uwkl
EOF


$ ./kafka/bin/kafka-topics.sh --bootstrap-server bootstrap.myingress.com:443 --command-config ./client.properties --list
__consumer_offsets
